...
\Verilog{Instruction Memory}{code:instmem}{../code/instr_mem.v}

The code is given in Listing~\ref{code:instmem}.  What needs to be tested?  How will it be used?  What can go wrong?  Consider those questions and write a test fixture and verify it's operation.
...
\Verilog{Starter code for the fetch stage.}{code:fetch}{../code/iFetch.v}
